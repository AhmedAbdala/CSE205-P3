...
public class Student implements Comparable<Student> {
    ...
    /**
     * mFirstName is a String of the student's first name.
     */
    ...
    /**
     * mLastName is a String ofThe student's last name.
     */
    ...
    public String toString() {
        ...
        String examsField = "";
        String homeworkField = "";

        for (int i: mExamList) {
            String strExam = String.valueOf(i);
            examsField += strExam + " ";
        }

        for (int i: mHomeworkList) {
            String strHomework = String.valueOf(i);
            homeworkField += strHomework + " ";
        }

        //return this.getLastName() + " " + this.getFirstName() + " " + examsField + homeworkField.trim();
        String studentInfo = lastName + " " + firstName + " " + examsField + " " + homeworkField;
        return studentInfo.trim();
    }
